...
<div class="card" v-if="editing">
    ...
    <div class="card-footer">
        <div class="level">
            <button class="btn btn-secondary btn-xs level-item" @click="editing = true" v-show="!editing">Edit</button>
            <button class="btn btn-primary btn-xs level-item" @click="">Update</button>
            <button class="btn btn-secondary btn-xs level-item" @click="editing = false">Cansel</button>
